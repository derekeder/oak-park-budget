...
endYear     = 2023;  // last year of budget data
activeYear  = 2023;  // default year to select
...
projectionStartYear = 2022; // if some numbers are projections into the future, set as year of first projection. otherwise, set null. it is assumed that estEndYear = endYear. this determines the chart x axis band
plotBandBuffer = 0;        // move the plot band start N months back, for styling


// Inflation Index (for inflation adjusted dollars)
// get latest CPI from https://www.usinflationcalculator.com/inflation/consumer-price-index-and-annual-percent-changes-from-1913-to-2008/
benchmark = 2023;
inflation_idx = {
    ...
    2020: 257.0, 2021: 270.1, 2022: 292.7, 2023: 292.7 
}
...
dataSource  = window.location.origin + '/data/final/oak_park_budget_cleaned.csv';
